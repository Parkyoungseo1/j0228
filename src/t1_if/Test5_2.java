 ...
 * 
 * 시간수당(sudang) : 시간(hour)을 입력받아서 1시간당 25000원으로 한다. 
 * 공제액(gongie) : (본봉(bonbong) + 수당)의 10%로 한다.
 * 실수령액(netpay)을 구하시오
 * 단, 실수령액 = 본봉 + 수당 - 공제액
 */
public class Test5_2 {
	public static void main(String[] args) {
		...
		int code, hour, gongie, bonbong, netpay, hap;
		String jikkub;
		...
		gongie = (int)((bonbong + (hour * 25000)) * 0.1);
		netpay = hap - gongie;
